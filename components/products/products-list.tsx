...
import { PRODUCT_CATEGORIES, FEATURED_PRODUCTS, WHATSAPP_LINK } from "@/lib/constants";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-[#5a7a5e] max-w-3xl mx-auto">
            Dr Lolo Cosmetics offers a variety of beauty and skincare products
            for customers looking for glow, body care, personal care, and
            complete beauty sets. Product availability may change depending on
            current stock, so customers are encouraged to contact us directly on
            WhatsApp for prices, product guidance, and orders.
          </p>
        </motion.div>
